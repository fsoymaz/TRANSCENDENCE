...
function gameLoop(e) {
    ...
    const endGame = () => {
        clearCanvas();
        socket.close();
        fetch("https://10.11.38.2/tournament/end_game/", {
            method: "POST",
...
export function setupTournament() {
    ...
    next_game_button.addEventListener("click", function () {
        message.textContent = "";
        next_game_button.style.display = "none";
        socket = new WebSocket(`wss://10.11.38.2/ws/tournament/${roomName + "f"}/`);
    ...
    document
        ...
        .addEventListener("submit", function (event) {
            ...
            socket = new WebSocket(`wss://10.11.38.2/ws/tournament/${roomName}/`);
            ...
            fetch("https://10.11.38.2/tournament/create_room/", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    roomNumber: roomName,
    ...
    document
        ...
        .addEventListener("submit", function (event) {
            ...
            fetch("https://10.11.38.2/tournament/join_room/", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    roomNumber: roomName,
